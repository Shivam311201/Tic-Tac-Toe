...
function Login(props) {
  const [placeHold, setfunction] = useState([0, 0]);
  const customStyle1 = {
    marginBottom: "60px",
    width: "20rem",
    height: "20rem",
  ...
  function settingHold(e) {
    if (placeHold[0] === 0 && e.target.id === "email") setfunction([1, 0]);
    else if (placeHold[1] === 0) setfunction([0, 1]);
  }
  return (
    <div class="row">
      <div class="col-lg-7 col-sm-12 bg-dark">
        <div
          style={{
      ...
      >
        ...
        <div style={{ marginTop: "10px", fontSize: "35px" }}>Sign in</div>
        <div>
        <div class="email" style={{ marginTop: "35px",paddingRight:"0px" }}>
          <OutsideClickHandler
            onOutsideClick={() => {
              setfunction([0, 0]);
            }}
          >
            <input
              id="email"
              placeholder={placeHold[0] === 1 ? "" : " Email Address*"}
              onClick={settingHold}
              style={{
                borderRadius: "4px",
        ...
        <div class="password" style={{ marginTop: "20px" }}>
          <OutsideClickHandler
            onOutsideClick={() => {
              setfunction([0, 0]);
            }}
          >
            <input
              id="password"
              placeholder={placeHold[1] === 1 ? "" : " Password*"}
              onClick={settingHold}
              type="password"
              style={{
                borderRadius: "4px",
        ...
        <div style={{ textAlign: "center", paddingTop: "40px" }}>
          Copyright ©
          <a class="text-dark" style={{ textDecoration: "none" }} href="#">
            {" Tic-Tac-Toe "}
          </a>
          2021.
        </div>
