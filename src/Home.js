...
function Home(props) {
  ...
  const [P1name, setname1] = useState("");
  const [P2name, setname2] = useState("");
  ...
  function getName(e) {
    console.log("hi");
    // e.preventdefault();
    var newarr = [P1name, P2name];
    props.playername(newarr);
  }
  function settingHold(e) {
    if (placeHold[0] === 0 && e.target.id === "1") setfunction([1, 0]);
  ...
  return (
    <div>
      ...
      <div style={{ textAlign: "center", marginTop: "20px" }}>
        ...
        <div>
          <img
            style={{ width: "200px", height: "200px", marginRight: "370px" }}
        ...
        <div style={{ display: "inline-block" }}>
          ...
          >
            <input
              ...
              value={P1name}
              onChange={changeName}
              placeholder={placeHold[0] === 1 ? "" : "Enter Player 1 name"}
              onClick={settingHold}
              autoComplete="off"
              style={{
                fontSize: "20px",
        ...
        <div style={{ display: "inline-block" }}>
          ...
          >
            <input
              ...
              value={P2name}
              onChange={changeName}
              placeholder={placeHold[1] === 1 ? "" : "Enter Player 2 name"}
              onClick={settingHold}
              autoComplete="off"
              style={{
                display: "inline-block",
